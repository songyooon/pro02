	...
	<div class="row" id="content_row">
		...
		<% } %>
			...
			<form name="frm1" id="frm1" action="<%=request.getContextPath() %>/QnaReplyWriteProCtrl.do" method="post">
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td>
								<textarea cols="100" rows="6" name="content" id="content" placeholder="내용 입력" class="form-control"></textarea>
							</td>
						</tr>
						<tr>
				...
				<div class="btn-group">
					<button type="submit" class="btn btn-outline-dark">답글 쓰기</button>&nbsp;&nbsp;&nbsp;&nbsp;
